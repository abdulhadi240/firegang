...
export function Sidebar({ userEmail, userFullName }: SidebarProps) {
  ...
  return (
    <>
      {/* ── Mobile top bar ── */}
      <div className="lg:hidden print:hidden fixed top-0 left-0 right-0 z-40 h-14 bg-white border-b border-gray-200 flex items-center justify-between px-4">
      ...
      {/* ── Desktop sidebar ── */}
      <aside className="hidden lg:flex print:hidden w-64 min-h-screen bg-white border-r border-gray-200 flex-col shrink-0">
